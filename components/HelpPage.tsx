            ...
            <HelpSection title="User Case Scenarios">
                ...
                <UserScenario role="Maintenance Technician" scenario="Investigating a Critical Propulsion Alert">
                    <ol className="list-decimal list-inside space-y-2">
                        ...
                        <li><strong>System Analysis:</strong> You navigate to 'Health Monitoring' &gt; 'Engine Health'. Here, you observe the Real-Time Charts. You also check the 'Engine Parameter Correlation Heatmap' and see a strong positive correlation (e.g., 0.81) between Vibration and EGT, suggesting a thermal-mechanical issue.</li>
